...
- Fix prototype/document previews rendering CJK text as tofu by syncing current-page fallback fonts automatically and requesting local font access before loading non-Latin fallback glyph coverage in the browser.
